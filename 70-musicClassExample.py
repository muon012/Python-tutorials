...
class Album:
	...
	Attributes:
		...
		artist (str): The name of the artist responsible for the album. If not specified, default is "Various Artists
	...
	def add_song(self, song, position=None):
		...
		Args:
			song (Song): The title of a song to be added.
			position (Optional)[int]): If specified, the song will be added at that position in the track
			list - inserting it between other songs if necessary. Otherwise, the song will be added to the end
			of the list.
		"""
...
class Artist:
	...
	Attributes:
		...
		albums (list): A list of the albums by this artist.
...
def find_object(field, object_list):
	"""Check 'object list' to see if an object with a 'name' equal to 'field' exists, returns it if so."""
