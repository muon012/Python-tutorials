...
# This checks that ALL elements in people have an email address.
# In the case where people is empty we need to add an additional conditional
...
if any(plant.plant_type == "Cactus" for plant in plants_dict.values()):
	print("This dictionary contains cacti")
else:
	print("No cacti in this dictionary")
